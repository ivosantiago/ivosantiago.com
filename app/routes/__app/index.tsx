...
//   title: "Ivo Santiago", // <title>Josie's Shake Shack</title>
//   description:
//     "Hello I’m Ivo, a software designer and entrepreneur based in New York City. I’m the founder and CEO of Planetaria, where we develop technologies that empower regular people to explore space on their own terms.", // <meta name="description" content="Delicious shakes">
...
export const loader = async () => {
  const articles: ArticleWithComponent[] = [];
  return json({
