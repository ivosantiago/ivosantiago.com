...
function MobileNavItem({
  to,
  children,
}: React.PropsWithChildren<MobileNavItemProps>) {
  return (
    <li>
          ...
          >
            ...
            <nav className="mt-6">
              <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
                ...
                <MobileNavItem to="/now">Now</MobileNavItem>
              </ul>
            </nav>
          </Popover.Panel>
        </Transition.Child>
...
function NavItem({ to, children }: React.PropsWithChildren<NavItemProps>) {
...
type AvatarContainerProps = React.ComponentProps<"div">;
...
type AvatarProps = Omit<LinkProps, "to"> & {
  large?: boolean;
};
